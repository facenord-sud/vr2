...
(function() {
  $(function() {
    var getNextPage, isFinished, loading, nearBottomOfPage;
    loading = false;
    nearBottomOfPage = function() {
      return $(window).scrollTop() > $(document).height() - $(window).height() - 200;
    };
    getNextPage = function() {
      return $('#paginate ul li a[rel=next]').attr('href');
    };
    isFinished = function() {
      var _ref;
      return (_ref = getNextPage() === void 0) != null ? _ref : {
        "true": false
      };
    };
  ...
  $(function() {
    ...
    return $('#continue').click(function() {
      return $('html body').animate({
        scrollTop: $('#image').offset().top - down
      }, 'slow');
    });
  });
